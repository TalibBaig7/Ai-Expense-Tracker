...
const AuthHero = ({ headline, subheadline }) => {
  /*
   * IMPORTANT:
   * Do not use Math.random() or any other impure function
   * while rendering the component.
   *
   * These arrays provide different-looking arrangements while
   * remaining completely deterministic and React-safe.
   */

  const column1Cards = [...column1, ...column1, ...column2];

  const column2Cards = [...column2, ...column2, ...column2];

  const column3Cards = [...column2, ...column1, ...column1];
      ...
      <div className="absolute inset-0 overflow-hidden z-10">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              {column1Cards.map((card, i) => (
                <div key={`column1-${i}`} className="pb-4">
                  {card}
                </div>
              ))}
            </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              {column2Cards.map((card, i) => (
                <div key={`column2-${i}`} className="pb-4">
                  {card}
                </div>
              ))}
            </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              {column3Cards.map((card, i) => (
                <div key={`column3-${i}`} className="pb-4">
                  {card}
                </div>
              ))}
            </div>
