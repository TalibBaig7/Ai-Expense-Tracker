...
const bottomNavLinkClass = ({ isActive }) =>
    `flex flex-col items-center justify-center gap-0.5 flex-1 py-2 text-[10px] font-medium transition ${
...
export const MobileBottomNav = () => (
    <nav className="fixed bottom-0 inset-x-0 z-30 bg-white border-t border-slate-100 lg:hidden safe-area-bottom">
