...
const Transactions = () => {
  ...
  const counts = useMemo(
    () => ({
      ...
      expense: (allTransactions || []).filter((t) => t.type === "expense")
        .length,
    }),
    [allTransactions],
  );
  ...
  const trendData = useMemo(() => {
    ...
    const source = Array.isArray(allTransactions) ? allTransactions : [];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Button onClick={onCreate} className="w-full sm:w-auto shrink-0">
      ...
      <div className="bg-white rounded-3xl border border-slate-100 p-4 sm:p-6">
        <div className="mb-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-1 bg-slate-100 p-1 rounded-full self-start">
            {[
              { value: "30d", label: "30D" },
              { value: "3m", label: "3M" },
      ...
      <div className="bg-white rounded-3xl border border-slate-100 p-4 sm:p-5">
        <div className="flex flex-col lg:flex-row lg:items-center gap-3 mb-5">
          ...
          <div className="flex flex-wrap items-center gap-1 bg-slate-100 p-1 rounded-full self-stretch sm:self-start lg:self-auto">
            {tabs.map((tab) => (
              <button
                key={tab.value || "all"}
                onClick={() => {
          ...
          <select
            ...
            className="w-full sm:w-auto px-4 py-2 rounded-full border border-slate-200 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-violet-500"
          >
        ...
        {loading ? (
          ...
          <>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-5 pt-5 border-t border-slate-100">
                ...
                <div className="flex items-center gap-1 overflow-x-auto pb-1">
                  <button
                    ...
                    disabled={safePage === 1}
                    className="h-8 w-8 flex items-center justify-center rounded-lg text-slate-600 hover:bg-slate-100 disabled:opacity-40 disabled:cursor-not-allowed transition shrink-0"
                  >
                    <ChevronLeft size={16} />
                  </button>
                  ...
                  {getPageNumbers().map((p, i) =>
                    p === "…" ? (
                      ...
                      <button
                        key={p}
                        onClick={() => setPage(p)}
                        className={`h-8 min-w-8 px-2.5 rounded-lg text-sm font-medium transition shrink-0 ${
                          safePage === p
            ...
            {totalPages > 1 && (
              <div className="md:hidden flex flex-col gap-3 mt-5 pt-5 border-t border-slate-100">
                ...
                <div className="flex items-center justify-center gap-1">
                  ...
                  {getPageNumbers().map((p, i) =>
                    p === "…" ? (
                      <span key={`m-gap-${i}`} className="px-1.5 text-slate-400 text-sm">
                        {p}
                      </span>
                    ) : (
                      <button
